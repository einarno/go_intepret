...
func testBooleanObject(t *testing.T, obj object.Object, expexted bool) bool {
	result, ok := obj.(*object.Boolean)
	if !ok {
		t.Errorf("Object is not Boolean got=%T (%+v)", obj, obj)
	}
	if result.Value != expexted {
		t.Errorf("Object is wrong value. got %t wanted=%t", result.Value, expexted)
		return false
	}
	return true
}
